/*
    ...
    Copyright (C) 2020 by Alexander Somma
...
Cloud.prototype.knownDomains = {
  'Snap!Cloud' : 'http://localhost:8080/https://cloud.snap.berkeley.edu',
  'Snap!Cloud (cs10)' : 'https://cors-anywhere.herokuapp.com/https://snap-cloud.cs10.org',
  'Snap!Cloud (staging)': 'https://cors-anywhere.herokuapp.com/https://snap-staging.cs10.org',
...
Cloud.prototype.request = function (
    ...
    try {
        ...
        //Changed to bypass CORS for testing
