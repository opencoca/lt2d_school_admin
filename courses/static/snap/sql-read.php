<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $query = "SELECT * FROM `experiment` WHERE session='".$session."' AND contributor='".$contributor."'";
        $result = $mysql->query($query);
        $numRows = $result->num_rows;
        $i = 1;

        //echo " <table><tr><td> Session Number </td><td> Contributor Name </td><td> Value Stored </td></tr>";
